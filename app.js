...
<p>A path is the address of a file or folder.</p>
<p><strong>Absolute Path:</strong> Full from root (e.g., C:\\Users\\John\\Documents\\file.txt).</p>
<p><strong>Relative Path:</strong> From current location (e.g., Documents\\file.txt).</p>
<h3>Examples</h3>
<ul><li>Absolute: /home/user/projects/report.pdf</li><li>Relative: projects/report.pdf</li></ul>
<h3>Visual Aids</h3>
...
<p>Use *.ext, datemodified:today, etc.</p>
<p>Example: *.pdf</p>
...
<p>Use Documents, Pictures, etc.</p>
<p>Tip: Create subfolders.</p>
`
        }
    };
    ...
    // Tools: Folder management with categories
